...
# CF-RAN, [5km-10km] distance between nodes
# 15 seconds
# 4, 8, 12, 16, 20 RRHs
# Traffic generation: [614Mb-24.3Gb]/ [1.0-5.0] s
# Channels: 10 of size 10000
import sys, os
sys.path.append("./../")
...
results_file = open(os.path.join("results", "cf_twdm3.txt") ,"w")
