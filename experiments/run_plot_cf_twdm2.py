...
# CF-RAN, 100000 units of distance between nodes
# Local nodes at ONU
# 5 seconds
# 4, 8, 12, 16, 20 RRHs
...
results_file = open(os.path.join("results", "cf_twdm2.txt") ,"w")
